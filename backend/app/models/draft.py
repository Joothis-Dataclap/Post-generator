...
class Draft(Base):
    ...
    # Link to the idea bundle that produced this draft
    idea_bundle_id: Mapped[str | None] = mapped_column(String(36), nullable=True, index=True)
    ...
    # Workflow status: pending → approved → scheduled | published | rejected
